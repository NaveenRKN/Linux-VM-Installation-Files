          ...
          <div className="row">
            ...
            <div className="col-md-6 grid-margin stretch-card">
              ...
              <div className="card tale-bg">
                ...
                <h3 className="mb-0 font-weight-normal"> Risk By Status </h3>
                    ...
                    <div className="card-body">
                      ...
                      <div className="charts-data">
                        <div className="mt-3">
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <div className="progress progress-md flex-grow-1 mr-4">
                              <div className="progress-bar bg-inf0" role="progressbar" style={{"width":" 95%"}}  ></div>
                            </div>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <div className="progress progress-md flex-grow-1 mr-4">
                              <div className="progress-bar bg-info" role="progressbar" style={{"width":" 35%"}}  ></div>
                            </div>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <div className="progress progress-md flex-grow-1 mr-4">
                              <div className="progress-bar bg-info" role="progressbar" style={{"width":" 48%" }}></div>
                            </div>
